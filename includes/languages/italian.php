 ...
 * @version GIT: $Id: Author: ajeh  Tue Oct 29 18:16:39 2013 -0400 Modified in v1.5.2 LaVale $
 */
...
define('ENTRY_COMPANY', 'Nome azienda:');
  define('ENTRY_COMPANY_ERROR', 'Devi inserire un Nome azienda.');
...
// shopping cart errors
  ...
  define('WARNING_PRODUCT_QUANTITY_ADJUSTED', 'La quantità è stato adattata a quanto in magazzino. ');
...
// create account - login shared
  ...
  define('ERROR_TEXT_COUNTRY_DISABLED_PLEASE_CHANGE', 'Ci dispiace ma non accettiamo più indirizzi di fatturazione o spedizione da "%s". Si prega di aggiornare questo indirizzo per continuare.');
